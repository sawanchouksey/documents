# Implement Gateway API in EKS in AWS Cloud
...
1. **GatewayClass**: This resource defines a set of gateway types offered by a service provider (which could be a cloud provider, an in-house team, or a third-party vendor). `GatewayClass` is a cluster-level resource that describes the types of gateways available, including the configuration parameters required for each type.
...
2. Run `kubectl` to deploy the controller. Check [Environment Variables](https://www.gateway-api-controller.eks.aws.dev/guides/environment/) for detailed explanation of each configuration option.
     ...
     template:
       ...
       spec:
         ...
         - args:
           ...
           command:
           - /manager
           image: public.ecr.aws/aws-application-networking-k8s/aws-gateway-controller:v1.0.3
           livenessProbe:
             httpGet:
               path: /healthz
               port: 8081
   ...
   ```
   kubectl apply -f https://github.com/aws/aws-application-networking-k8s/tree/main/examples/deploy-v1.0.3.yaml
   ```

3. Create the `amazon-vpc-lattice` GatewayClass.
   ...
   ```
   kubectl apply -f https://github.com/aws/aws-application-networking-k8s/blob/main/examples/gatewayclass.yaml
   ```

4. Create or deploy `Gateway` with `amazon-vpc-lattice` GatewayClass.
   ...
   ```
   kubectl apply -f https://github.com/aws/aws-application-networking-k8s/blob/main/examples/my-hotel-gateway.yaml
   ```

5. Create `HTTPRoute` for Routing traffic to eks in various services or deployment using `my-hotel`  gateway as `parentRefs`.
   ...
   ```
   kubectl apply -f https://github.com/aws/aws-application-networking-k8s/blob/main/examples/rate-route-path.yaml
   ```

6. Create deploy `HTTPRoute` with `TLS cert` as well.
   ...
   ```
   kubectl apply -f https://github.com/aws/aws-application-networking-k8s/blob/main/examples/tls-route-with-own-cert.yaml
   ```

NOTE : 

Please modify or update `HTTPRoute` with respect to your `path` and your requirements. It is just an example for demonstrate the deployment process.

### Refrences:

https://www.gateway-api-controller.eks.aws.dev/guides/deploy/

[Basic Setup - AWS Gateway API Controller](https://www.gateway-api-controller.eks.aws.dev/guides/getstarted/)

https://github.com/aws/aws-application-networking-k8s/tree/main/examples

https://github.com/aws/aws-application-networking-k8s/tree/main/docs

### Support Me

**If you find my content useful or enjoy what I do, you can support me by buying me a coffee. Your support helps keep this website running and encourages me to create more content.**

[![Buy Me a Coffee](https://camo.githubusercontent.com/12f516d86d600c89a6abd2326256045c27325ad7c8532c0d36772965a4923be0/68747470733a2f2f7777772e6275796d6561636f666665652e636f6d2f6173736574732f696d672f637573746f6d5f696d616765732f6f72616e67655f696d672e706e67)](https://www.buymeacoffee.com/sawanchokso)

**Your generosity is greatly appreciated!**

##### [](https://github.com/sawan22071995/notes/blob/main/docs/Cloud/CloudTransitionMigrationGCP.md#thank-you-for-your-support)Thank you for your support!💚
