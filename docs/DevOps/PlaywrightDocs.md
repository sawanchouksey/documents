...
const loginPayLoad = {userEmail:"<YOUR_EMAIL>",userPassword:"<YOUR_PASSWORD>"}; // Define the login payload with user credentials
...
test('@QW Security test request intercept', async ({ page }) => {
    ...
    await page.goto("https://rahulshettyacademy.com/client"); // Navigate to the client page
    await page.locator("#userEmail").fill("<YOUR_EMAIL>"); // Fill in the email field
    await page.locator("#userPassword").fill("<YOUR_PASSWORD>"); // Fill in the password field
